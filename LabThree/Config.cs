...
namespace LabThree
{
    ...
    public static class Config
    {
        ...
        /// </summary>
        public static int? ArProgIncDiff_1(int a, int b) => a - b;
        ...
        /// </summary>
        public static int? ArProgDecDiff_1(int a, int b) => ArProgIncDiff_1(b, a);

        /// <summary>
        /// Убывающая арифметическая последовательность с произвольным шагом
        /// </summary>
        public static int? ArProgDecDiff(int a, int b, int step) => ArProgIncDiff(b, a, step) * -1;
